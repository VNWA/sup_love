...
/**
 * Bản dịch tiếng Việt cho validation (gộp trên bản en, thay toàn bộ thông điệp).
 *
 * @var array<string, mixed> $en
 */
$en = require __DIR__.'/../en/validation.php';
...
return array_replace_recursive($en, [
    ...
    'ascii' => 'Trường :attribute chỉ được chứa ký tự và số một byte.',
    ...
    'encoding' => 'Trường :attribute phải được mã hóa dạng :encoding.',
    ...
    'filled' => 'Trường :attribute phải có dữ liệu.',
    'gt' => [
    ...
    'lt' => [
        'array' => 'Trường :attribute phải ít hơn :value phần tử.',
    ...
    'mimes' => 'Trường :attribute phải là tệp dạng: :values.',
    'mimetypes' => 'Trường :attribute phải là tệp dạng: :values.',
    'min' => [
    ...
    'attributes' => [
        ...
        'name' => 'họ tên',
        'point' => 'điểm',
        'bet_choice_id' => 'ô cược',
        'bet_amount' => 'số điểm cược',
        'wheel_room_id' => 'phòng quay',
    ],
]);
